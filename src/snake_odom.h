...
class Snake_odom{
  public:
    ...
    static void Initialize() {
      ...
      sub_start_odom_ = node.subscribe("odom_flag", 1, odom_start_Callback);
      pub_collision_marker_ = node.advertise<sensor_msgs::PointCloud>("collision_mark_w", 1);
    ...
    static geometry_msgs::Point Point32_to_Point(geometry_msgs::Point32 pt);
    static geometry_msgs::Point32 Point_to_Point32(geometry_msgs::Point pt);
    static void set_tf_listener(tf::TransformListener ptr){ listener_ = &ptr; }
  ...
  private:
    ...
    //--- Publisher ---//
    static ros::Publisher pub_collision_marker_;
